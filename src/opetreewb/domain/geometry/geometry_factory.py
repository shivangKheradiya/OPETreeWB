...
def create_geometry(node, doc):
    ...
    if type_name == "STRA":
        try:
            from opetreewb.SKET.geometry.stra.stra_factory import \
                create_stra_object
        ...
        try:
            from opetreewb.SKET.geometry.rect.rect_factory import \
                create_rect_object
        ...
        try:
            from opetreewb.SKET.geometry.circ.circ_factory import \
                create_circ_object
        ...
        try:
            from opetreewb.SKET.geometry.arc.arc_factory import \
                create_arc_object
        ...
        try:
            from opetreewb.SKET.geometry.elli.elli_factory import \
                create_elli_object
        ...
        try:
            from opetreewb.SKET.geometry.texp.texp_factory import \
                create_texp_object
        ...
        try:
            from opetreewb.SKET.geometry.hexa.hexa_factory import \
                create_hexa_object
