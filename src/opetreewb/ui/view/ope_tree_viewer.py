...
from opetreewb.domain.services.service_locator import (get_client,
...
class OPETreeViewer(QtWidgets.QTreeWidget):
    ...
    def _on_selection_changed(self):
        ...
        FreeCAD.Console.PrintMessage(f"[OPE Tree] Selected node: {node.label}\n")
    ...
    def _on_item_expanded(self, item):
        ...
        FreeCAD.Console.PrintMessage(f"[OPE Tree] Expanding node {node.label}\n")
    ...
    def _create_child_node(self, parent_item):
        ...
        if not allowed_types:
            QtWidgets.QMessageBox.information(
                self, "Not Allowed", "This element cannot have children."
            )
            return
    ...
    def _delete_node(self, item):
        ...
        FreeCAD.Console.PrintMessage(f"✅ Delete request sent: {lable}\n")
    ...
    def _addIn3D_node(self, item):
        ...
        FreeCAD.Console.PrintMessage(f"✅ Geometry built for: {node.label}\n")
    ...
    def _remFrom3D_node(self, item):
        ...
        FreeCAD.Console.PrintMessage(f"✅ Geometry removed for: {node.label}\n")
    ...
    def _create_root_node(self):
        ...
        FreeCAD.Console.PrintMessage(f"✅ Created root: {element_type} {name}\n")
